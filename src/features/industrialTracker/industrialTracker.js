...
export const industrialTracker = createSlice({
    name: 'industrialTracker',
    initialState: {
      name:'TEKTELIC GPS Asset Tracker',
...
export const selectIndustrialTracker = state => state.industrialTracker;
export const selectIndustrialTrackerDescription = state => state.industrialTracker.description
export const selectIndustrialTrackerCategories = state => state.industrialTracker.categories

export default industrialTracker.reducer;