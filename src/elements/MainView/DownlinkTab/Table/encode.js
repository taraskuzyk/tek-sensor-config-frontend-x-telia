const BitManipulation = {
    ...
    // a replacement for "BigInt" since "BigInt" is not backwards compatible with ECMASript 5.1 and earlier
...
export default function encode(commands, sensor) {
    // encodes the commands object into a nested array of bytes based on the provided sensor object
